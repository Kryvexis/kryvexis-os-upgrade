...
export function SettingsPage() {
  ...
  return (
    <div className="page-stack">
      <PageHeader title="Settings" description="A real app settings space for user profile, theme, role selection, branch context, and workspace preferences." actions={<button className="soft-button primary">Save preferences</button>} />
        ...
        <div className="settings-grid two-up">
          ...
          <div className="profile-card muted-card">
            <div>
              ...
              <p>Kryvexis OS workspace with responsive shell, role-aware nav, notifications center, and deployment-ready theme controls.</p>
            </div>
          </div>
        </div>
      </SettingsSection>
      ...
      <SettingsSection title="Roles & access" description="Switch role-focused workspace modes for testing the shell structure and page visibility.">
        <div className="choice-grid">
      ...
      <SettingsSection title="Branch & workflow" description="Starter controls for branch context and how users receive alerts, approvals, and activity.">
        <div className="settings-grid two-up">
