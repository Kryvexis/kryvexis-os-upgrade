...
export type WorkspaceSummary = { id: string; slug: string; companyName: string; adminName: string; email: string; branchCount: number; userCount: number; active: boolean; };
export type WorkspaceContextResponse = { activeWorkspaceId: string | null; workspaces: WorkspaceSummary[]; workspace?: WorkspaceAdminResponse; };
export type CreateWorkspacePayload = CompanyProfile & { logoDataUrl?: string; logoFileName?: string; };
export type WorkspaceAdminResponse = { workspaceId?: string; workspaceLabel?: string; availableWorkspaces?: WorkspaceSummary[]; companyProfile: CompanyProfile; documentBranding: DocumentBranding; branches: WorkspaceBranch[]; users: WorkspaceUser[]; rolePolicies: WorkspaceRolePolicy[]; importJobs: ImportJob[]; };
