...
export const api = {
  ...
  workspaces: () => request<WorkspaceContextResponse>('/api/workspaces'),
  selectWorkspace: (workspaceId: string) => request<WorkspaceContextResponse>('/api/workspaces/select', { method: 'POST', body: JSON.stringify({ workspaceId }) }),
  createWorkspace: (payload: CreateWorkspacePayload) => request<WorkspaceAdminResponse>('/api/workspaces', { method: 'POST', body: JSON.stringify(payload) }),
  workspaceAdmin: () => request<WorkspaceAdminResponse>('/api/workspace-admin'),
