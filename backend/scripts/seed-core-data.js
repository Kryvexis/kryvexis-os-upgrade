...
async function main() {
  ...
  await query(`insert into customers (id, name, owner, branch_id, status, balance, credit_terms_days, price_list, risk_level, contact_email, phone, notes)
    values
      ('CUS-001', 'Acme Retail Group', 'Rina Patel', 'BR-JHB', 'Needs follow-up', 27400.00, 30, 'Wholesale A', 'Medium', 'accounts@acmeretail.co.za', '+27 11 555 0144', 'Payment discipline improved after the February reminder cycle.'),
      ('CUS-002', 'Northline Foods', 'Alex Morgan', 'BR-CPT', 'Healthy', 8920.00, 14, 'Hospitality', 'Low', 'payables@northlinefoods.co.za', '+27 21 555 0198', 'High repeat order volume and fast payment turnaround.'),
      ('CUS-003', 'Urban Build Supply', 'Tariq Naidoo', 'BR-DBN', 'Approval watch', 61800.00, 45, 'Construction', 'Medium', 'ops@urbanbuild.co.za', '+27 31 555 0112', 'High-value quote pending approval threshold.')
    on conflict (id) do nothing`);
  ...
  await query(`insert into products (id, sku, name, branch_id, status, stock, reorder_at, price, cost, supplier_id, barcode, variants)
    values
      ('PRD-1001', 'SKU-1001', 'Kryvexis Label Printer', 'BR-JHB', 'Healthy', 14, 10, 2499.00, 1620.00, 'SUP-001', '6001001001001', 'Standard / Black'),
      ('PRD-1021', 'SKU-1021', 'Thermal Roll Box', 'BR-CPT', 'Low stock', 8, 12, 380.00, 210.00, 'SUP-002', '6001001001021', '80mm / 24 pack'),
